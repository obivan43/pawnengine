...
namespace pawn {
	...
	GraphicsInputElement::GraphicsInputElement(const std::string& name, GraphicsInputElementType type) : Name(name), Type(type), Size(GraphicsInputElementTypeSize(type)), Offset(0) {}
	...
	void GraphicsInputLayout::Bind(std::shared_ptr<GraphicsContext>& context) {}
